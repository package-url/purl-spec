Package URL core specification v1.0-SNAPSHOT
============================================

The core specification defines a versioned and formalized format, syntax, and
rules used to represent and validate `purl`.
