...
The PURL **qualifiers** component is intended to provide flexibility to define
important PURL information at the PURL **type** level. This flexibility is
...
- 'vcs_url' should be used to provide a URL for a version control system (aka
  SCM or VCS) for the use case where you need to specify a PURL for a package
  at its SCM/VCS location. The syntax for 'vcs_url' should follow the Python
  pip syntax or the SPDX specification for
  ["Package Download Location"](https://github.com/spdx/spdx-spec/blob/cfa1b9d08903/chapters/3-package-information.md#3.7).
...
- 'vers' allows the specification of a version range instead of a single
  ...
  version range for dependency analysis or vulnerability reporting. Use of
  this **key** is mutually exclusive with the **version** component. The
