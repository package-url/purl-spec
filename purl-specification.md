...
See [PURL-TYPES.rst](PURL-TYPES.rst) for registered type definitions.
...
- MAY be composed of any of the characters defined in the "[Permitted characters](#permitted-characters)" section
- MUST be encoded as defined in the "[Character encoding](#character-encoding)" section

The "lowercase" rules are defined in the "[Case folding](#case-folding)" section.
...
- **is\_invalid**: a boolean flag set to true if the test should report an
  error
