...
- The `distro` is the qualifiers key for the distribution associated to
  the package.
...
- The qualifiers: `build` is the build string. `channel` is the package
...
- The `version` is the model revision Git commit hash. It is case
