...
This is an issue template for registering a new PURL type. Registration is our name for the process to create a new PURL type.  
...
A draft PR may be a good way to document the PURL component level definitions in a `<new-purl-type>.definition.json` file, but a PR is not a substitute for an issue because an issue should be the primary forum for the initial discussion.
