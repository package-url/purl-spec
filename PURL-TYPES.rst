...
- The qualifier ``tagCreatorName`` is optional. If the tagCreator is different from the softwareCreator, the tagCreatorName qualifier should be specified
- The qualifier ``tagCreatorRegId`` is optional. If the tagCreator is different from the softwareCreator, the tagCreatorRegId qualifier should be specified
